...
import explainCodePrompt from '@/prompts/commands/explain-code.md?raw'
import fixCodePrompt from '@/prompts/commands/fix-code.md?raw'
import refactorCodePrompt from '@/prompts/commands/refactor-code.md?raw'
import testCodePrompt from '@/prompts/commands/test-code.md?raw'
