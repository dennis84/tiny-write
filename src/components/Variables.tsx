...
export const Variables = () => {
  ...
  createEffect(() => {
    ...
    root.style.setProperty('--background-0', `${configService.theme.background}00`)
    ...
    root.style.setProperty('--menu-font-family', ConfigService.DEFAULT_MENU_FONT)
    root.style.setProperty('--menu-font-family-bold', `${ConfigService.DEFAULT_MENU_FONT} bold`)
